...
1. **Service** (ClusterIP): Exposes virtbmc Deployment on ports 623 (UDP) for IPMI and 80 (TCP) for Redfish
2. **Deployment**: Runs the virtbmc BMC emulator
